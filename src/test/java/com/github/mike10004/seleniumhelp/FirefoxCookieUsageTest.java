...
public class FirefoxCookieUsageTest {
    ...
    private List<DeserializableCookie> browseAndSetCookies(URL url, XvfbController xvfbController) throws IOException {
        WebDriverFactory factory = new FirefoxWebDriverFactory(xvfbController.configureEnvironment(new HashMap<>()), ImmutableMap.of(), ImmutableList.of());
    ...
    public void testCookieUsage() throws Exception {
        ...
        try (XvfbController xvfbController = xvfb.getController()) {
            ...
            WebDriverFactory factory = new FirefoxWebDriverFactory(xvfbController.configureEnvironment(new HashMap<>()), ImmutableMap.of(), cookiesSetByServer);
    ...
    private static DeserializableCookie newCookie(String name, String value) {
