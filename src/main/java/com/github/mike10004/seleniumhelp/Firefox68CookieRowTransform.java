...
public class Firefox68CookieRowTransform implements FirefoxCookieRowTransform {
    ...
    public Firefox68CookieRowTransform() {
        ...
        converter = new Converter<Map<String, Object>, Map<String, String>>() {
            ...
            protected Map<String, String> doForward(Map<String, Object> explodedCookie) {
                List<String> columnNames = _sqliteFieldToCookieValueGetterMap.keySet().asList();
                return Firefox68CookieRowTransform.this.apply(columnNames, explodedCookie);
            }
    ...
    public Converter<Map<String, Object>, Map<String, String>> asConverter(List<String> columnNames) {
        return converter;
    }
    ...
    public Map<String, String> apply(List<String> columnNames, Map<String, Object> explodedCookie) {
